...
from secs.models.components.base_encoder import FingerprintEncoder
...
if __name__ == "__main__":
    ...
    trainer = Trainer(
        max_epochs=25, accelerator="gpu", devices=1, logger=WandbLogger(project="fp_vae_lightning", name="fp_vae_experiment")
    )
