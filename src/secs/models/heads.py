...
ACTIVATION_RESOLVER = ClassResolver([nn.ReLU, nn.LeakyReLU, nn.Sigmoid, nn.Tanh], base=nn.Module, default=nn.ReLU)
...
class ProjectionHead(nn.Module):
    def __init__(
        ...
        self.projection_head = self._build_projection_head(dims=dims, activation=activation)
